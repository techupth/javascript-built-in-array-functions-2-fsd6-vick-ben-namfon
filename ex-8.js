...
function getTotalPaymentByLocation(bills) {
  const totalPaidByLocation = {};

  bills.forEach((bill) => {
    const payment = bill.total;
    if (totalPaidByLocation.hasOwnProperty(bill.location)) {
      totalPaidByLocation[bill.location] += payment;
    } else {
      totalPaidByLocation[bill.location] = payment;
    }
  });
...
console.log(getTotalPaymentByLocation(bills));
